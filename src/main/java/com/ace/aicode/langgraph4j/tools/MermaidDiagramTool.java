package com.ace.aicode.langgraph4j.tools;
...
import com.ace.aicode.langgraph4j.state.ImageCategoryEnum;
import com.ace.aicode.langgraph4j.state.ImageResource;
import com.ace.aicode.manager.CosManager;
...
public class MermaidDiagramTool {
    ...
    private File convertMermaidToSvg(String mermaidCode) {
        ...
        // 创建临时输入文件
        File tempInputFile = FileUtil.createTempFile("mermaid_input_", ".mmd", tempDir, true);
        FileUtil.writeUtf8String(mermaidCode, tempInputFile);
        // 创建临时输出文件
        File tempOutputFile = FileUtil.createTempFile("mermaid_output_", ".svg", tempDir, true);
        // 根据操作系统选择命令
